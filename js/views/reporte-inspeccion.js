    ...
    (function setupCharts() {
        ...
        function updatePeriodSelects() {
            ...
            if (periodo === 'Semanal') {
                ...
                if (yearHasta) {
                    ...
                    if (weeksHasta.length > 0) {
                        chartHastaWeek.value = weeksHasta[weeksHasta.length - 1];
                    }
                }
            } else {
        ...
        function renderChart() {
            ...
            chartInstance = new Chart(ctx, {
                type: 'bar',
                data: {
                    labels: dataPoints.map(d => d.fullLabel),
                    datasets: [
                        {
        ...
        function updateDefectosPeriodSelects() {
            ...
            if (periodo === 'Semanal') {
                ...
                if (yearHasta) {
                    ...
                    if (weeksHasta.length > 0) {
                        defectosHastaWeek.value = weeksHasta[weeksHasta.length - 1];
                    }
                }
            } else {
                document.getElementById('defectosDesdeYearLabel').style.display = '';
